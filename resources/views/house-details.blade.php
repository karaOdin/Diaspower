                    ...
                    <div class="row">        	
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                            ...
                            <div class="detail-slider">
                                <div class="feature-slider">
                                    <div><img src="/storage/{{$house->image}}"/></div>
                                    <?php $images = json_decode($house->mult_image) ?>
                                    <?php $images1 = json_decode($house->mult_image) ?>
                                ...
                                <div class="feature-slider-nav">
                                    <div><img src="/storage/{{$house->image}}" class="img-responsive" alt="feature-thumb"/></div>
                                    ...
                                    <div id="hotel-overview" class="tab-pane in active">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="/storage/{{$house->image}}" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 side-bar right-side-bar">
                            ...
                            <div class="side-bar-block booking-form-block">
                            	<h2 class="selected-price">{{$house->pricePerDay}} <span>Par Nuit</span></h2>
                            
                            	<div class="booking-form">
                                	<h3>Réserver un maison</h3>
                                    <p>Trouvez votre maison aujourd'hui</p>
                                    
                                    <form method="post" action="{{route('HouseReservations.store')}}">
                                    	{{ csrf_field() }}
                                        ...
                                        <input type="text" name="price" value="{{$house->pricePerDay}}" hidden>
                                        <input type="text" name="house_id" value="{{$house->id}}" hidden>
                                        <input type="text" name="rental_agncy_id" value="{{$house->rentalagency->id}}" hidden>
                                        <input type="text" name="city_id" value="{{$house->city->id}}" hidden>
